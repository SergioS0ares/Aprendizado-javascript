...
1. [Propriedades, Métodos e Valores Curtos](#propriedades-métodos-e-valores-curtos)  
2. [Acessando Valores do Objeto](#acessando-valores-do-objeto)  
3. [Destructuring](#destructuring)  
4. [Verificando a Existência de Propriedades](#verificando-a-existência-de-propriedades)  
5. [Adicionando e Atualizando Propriedades no Objeto](#adicionando-e-atualizando-propriedades-no-objeto)  
6. [Removendo a Propriedade do Objeto](#removendo-a-propriedade-do-objeto)  
7. [Mesclando e Clonando Objetos](#mesclando-e-clonando-objetos)  
8. [Clonagem de Objetos Rasos e Profundos](#clonagem-de-objetos-rasos-e-profundos)
